...
public struct HexSettings: Codable, Equatable, Sendable {
	...
	public var enableAIProcessing: Bool
	public var aiProcessingPrompt: String
	public var selectedOllamaModel: String
	public var useAccessibilityAPI: Bool
	public var aiModifierKey: Key?
	public var aiResponseReadingSpeed: Double
	public var ollamaSystemPrompt: String
	...
	public init(
		...
		aiProcessingPrompt: String = "Format this text with proper punctuation and grammar.",
		selectedOllamaModel: String = "llama3.2",
		useAccessibilityAPI: Bool = false,
		aiModifierKey: Key? = nil,
		aiResponseReadingSpeed: Double = 250.0,
		ollamaSystemPrompt: String = "You are a helpful assistant. Answer concisely and accurately."
	) {
...
private enum HexSettingsSchema {
	...
	nonisolated(unsafe) static let fields: [AnySettingsField] = [
		...
		SettingsField(.enableAIProcessing, keyPath: \.enableAIProcessing, default: defaults.enableAIProcessing).eraseToAny(),
		SettingsField(.aiProcessingPrompt, keyPath: \.aiProcessingPrompt, default: defaults.aiProcessingPrompt).eraseToAny(),
		SettingsField(.selectedOllamaModel, keyPath: \.selectedOllamaModel, default: defaults.selectedOllamaModel).eraseToAny(),
		SettingsField(.useAccessibilityAPI, keyPath: \.useAccessibilityAPI, default: defaults.useAccessibilityAPI).eraseToAny(),
		SettingsField(
			.aiModifierKey,
			keyPath: \.aiModifierKey,
			default: defaults.aiModifierKey,
			encode: { container, key, value in
				try container.encodeIfPresent(value, forKey: key)
			}
		).eraseToAny(),
		SettingsField(.aiResponseReadingSpeed, keyPath: \.aiResponseReadingSpeed, default: defaults.aiResponseReadingSpeed).eraseToAny(),
		SettingsField(.ollamaSystemPrompt, keyPath: \.ollamaSystemPrompt, default: defaults.ollamaSystemPrompt).eraseToAny()
	]
}
